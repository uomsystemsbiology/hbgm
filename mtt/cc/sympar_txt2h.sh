#! /bin/sh
# $Id: sympar_txt2h.sh,v 1.10 2008/10/04 15:42:10 geraint Exp $
# $Log: sympar_txt2h.sh,v $
# Revision 1.10  2008/10/04 15:42:10  geraint
# Dash chokes on backtick, so replaced with
#

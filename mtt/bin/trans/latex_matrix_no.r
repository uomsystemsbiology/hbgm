...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% $Id: latex_matrix_no.r,v 1.1 2014/04/18 00:31:40 gawthrop Exp $
%% $Log: latex_matrix_no.r,v $
%% Revision 1.1  2014/04/18 00:31:40  gawthrop
%% Latex matrix with no parentheses
%%
